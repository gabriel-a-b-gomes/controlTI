...
namespace ControleTiAPI.Migrations
{
    ...
    [Migration("20230125192121_CreationOfDevicesComputerScenario")]
    partial class CreationOfDevicesComputerScenario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleTiAPI.Models.ComputerProcessingUnit", b =>
                {
                    b.Property<int>("computerId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("computerId", "processingUnitId");

                    b.HasIndex("processingUnitId");

                    b.ToTable("computerProcessingUnit", "ti");
                });
            ...
            modelBuilder.Entity("ControleTiAPI.Models.ComputerProfile", b =>
                {
                    ...
                    b.ToTable("ComputerProfile", "ti");
                });

            modelBuilder.Entity("ControleTiAPI.Models.ComputerStorage", b =>
                {
                    ...
                    b.HasKey("storageId", "computerId");

                    b.HasIndex("computerId");

                    b.ToTable("computerStorage", "ti");
                });
