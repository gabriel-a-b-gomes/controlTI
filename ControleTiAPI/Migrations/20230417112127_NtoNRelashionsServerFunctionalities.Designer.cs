...
namespace ControleTiAPI.Migrations
{
    ...
    [Migration("20230417112127_NtoNRelashionsServerFunctionalities")]
    partial class NtoNRelashionsServerFunctionalities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleTiAPI.Models.HostFuncionalities", b =>
                {
                    ...
                    b.HasKey("hostId", "functionalityId");

                    b.HasIndex("functionalityId");

                    b.ToTable("HostFuncionalities", "ti");
                });
            ...
            modelBuilder.Entity("ControleTiAPI.Models.VMFunctionalities", b =>
                {
                    b.Property<int>("vmId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("vmId", "functionalityId");

                    b.HasIndex("functionalityId");

                    b.ToTable("VMFunctionalities", "ti");
                });
            ...
            modelBuilder.Entity("ControleTiAPI.Models.HostFuncionalities", b =>
                {
                    b.HasOne("ControleTiAPI.Models.ServerFunctionality", "functionality")
                        .WithMany("hosts")
            ...
            modelBuilder.Entity("ControleTiAPI.Models.VMFunctionalities", b =>
                {
                    ...
                    b.HasOne("ControleTiAPI.Models.ServerVM", "virtualMachine")
                        .WithMany("functionalities")
                        .HasForeignKey("vmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
