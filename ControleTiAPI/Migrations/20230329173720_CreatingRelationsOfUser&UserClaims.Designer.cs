...
namespace ControleTiAPI.Migrations
{
    ...
    [Migration("20230329173720_CreatingRelationsOfUser&UserClaims")]
    partial class CreatingRelationsOfUserUserClaims
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ControleTiAPI.Models.UserClaims", b =>
                {
                    b.HasOne("ControleTiAPI.Models.User", "user")
                        .WithOne("userClaims")
                        .HasForeignKey("ControleTiAPI.Models.UserClaims", "userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
